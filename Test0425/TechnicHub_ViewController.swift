...
class TechnicHub_ViewController: UIViewController {
    ...
    @IBOutlet weak var HW_C_Label: UILabel!
    @IBOutlet weak var HW_D_Label: UILabel!
    ...
    @objc func UpdateView(){
        ...
        self.HW_C_Label.text = hub?.Port[2].Hardware.Name() //BLEMANAGER.BLEHub[HubId].attatchedHw.PortC.Name()
        self.HW_D_Label.text = hub?.Port[3].Hardware.Name() //BLEMANAGER.BLEHub[HubId].attatchedHw.PortD.Name()
        
        print("\(Fire.Port[0].Name)")
    }
    /*
    // MARK: - Navigation
